...
/* package gpa-0.1.0.0 */
#ifndef VERSION_gpa
#define VERSION_gpa "0.1.0.0"
#endif /* VERSION_gpa */
#ifndef MIN_VERSION_gpa
#define MIN_VERSION_gpa(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_gpa */
...
#define CURRENT_PACKAGE_KEY "gpa-0.1.0.0-4xxCewutQXsGaDNSN2dgNI"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "gpa-0.1.0.0-4xxCewutQXsGaDNSN2dgNI"
